...
export default function FooterButtons(props: IFooterButtons) {
    ...
    return (
        ...
        flex text-2xl md:text-4xl p-2 items-center rounded-lg text-white`}>
            {props.children}
            <div
                style={{ width: hovered ? ref.current?.offsetWidth || 0 : 0 }}
                className={`overflow-x-hidden transition-all duration-300 ease-out`}>
                <span ref={ref} className=' text-2xl md:text-4xl px-1.5 font-kang-pixels cursor-pointer hover:underline'>
